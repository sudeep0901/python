 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.consumerdata.Address.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getAddress();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {!proto.consumerdata.Address} The clone.
 */
proto.consumerdata.Address.prototype.cloneMessage = function() {
  return /** @type {!proto.consumerdata.Address} */ (jspb.Message.cloneMessage(this));
};
