...
/***/ function(module, exports) {
	...
	goog.json.Serializer.prototype.serializeObject_=function(a,b){b.push("{");var c="",d;for(d in a)if(Object.prototype.hasOwnProperty.call(a,d)){var e=a[d];"function"!=typeof e&&(b.push(c),this.serializeString_(d,b),b.push(":"),this.serializeInternal(this.replacer_?this.replacer_.call(a,d,e):e,b),c=",")}b.push("}")};var jspb={ExtensionFieldInfo:function(a,b,c,d,e,f,g,h,k,l){this.fieldIndex=a;this.fieldName=b;this.ctor=c;this.toObjectFn=d;this.binaryReaderFn=f;this.binaryWriterFn=g;this.binaryMessageSerializeFn=h;this.binaryMessageDeserializeFn=k;this.isRepeated=e;this.isPacked=l}};jspb.ExtensionFieldInfo.prototype.isMessageType=function(){return!!this.ctor};jspb.Message=function(){};jspb.Message.GENERATE_TO_OBJECT=!0;jspb.Message.GENERATE_FROM_OBJECT=!goog.DISALLOW_TEST_ONLY_CODE;
	...
	jspb.Message.materializeExtensionObject_=function(a,b){if(a.array.length){var c=a.array.length-1,d=a.array[c];if(d&&"object"==typeof d&&!goog.isArray(d)){a.pivot_=c-a.arrayIndexOffset_;a.extensionObject_=d;return}}-1<b?(a.pivot_=b,c=jspb.Message.getIndex_(a,b),a.extensionObject_=jspb.Message.MINIMIZE_MEMORY_ALLOCATIONS?null:a.array[c]={}):a.pivot_=Number.MAX_VALUE};
	...
	jspb.Message.serializeBinaryExtensions=function(a,b,c,d){for(var e in c){var f=c[e];if(!f.binaryWriterFn)throw Error("Message extension present that was generated without binary serialization support");var g=d.call(a,f);if(g)if(f.isMessageType())if(f.binaryMessageSerializeFn)f.binaryWriterFn.call(b,f.fieldIndex,g,f.binaryMessageSerializeFn);else throw Error("Message extension present holding submessage without binary support enabled, and message is being serialized to binary format");else f.binaryWriterFn.call(b,
	f.fieldIndex,g)}};jspb.Message.readBinaryExtension=function(a,b,c,d,e){if(c=c[b.getFieldNumber()]){if(!c.binaryReaderFn)throw Error("Deserializing extension whose generated code does not support binary format");var f;c.isMessageType()?(f=new c.ctor,c.binaryReaderFn.call(b,f,c.binaryMessageDeserializeFn)):f=c.binaryReaderFn.call(b);c.isRepeated&&!c.isPacked?(b=d.call(a,c))?b.push(f):e.call(a,c,[f]):e.call(a,c,f)}else b.skipField()};
	...
	jspb.Message.toMap=function(a,b,c,d){for(var e={},f=0;f<a.length;f++)e[b.call(a[f])]=c?c.call(a[f],d,a[f]):a[f];return e};jspb.Message.prototype.toArray=function(){return this.array};jspb.Message.prototype.toString=function(){return this.array.toString()};
